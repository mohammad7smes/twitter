            ...
            <div className="w-[90%] xl:w-[75%] sticky top-0 bg-white py-1.5 z-50">
                <div className="flex items-center p-3 rounded-full bg-red-200 relative">
                    ...
                    <input
                        ...
                        className="absolute inset-0 rounded-full pl-11 border-r-gray-500 text-gray-700 focus:shadow-lg focus:bg-white bg-gray-100"
                    />
                </div>
            </div>
                ...
                {randomUsersResults.slice(0,randomUserNum).map((randomUser) => (
                    <div key={randomUser.login.username} className="flex items-center px-4 py-2 cursor-pointer hover:bg-gray-200">
                        <img src={randomUser.picture.thumbnail}
                            className="rounded-full" width="40" alt="" />
